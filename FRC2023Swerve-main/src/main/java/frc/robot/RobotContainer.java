...
public class RobotContainer {
  ...
  private void configureBindings() {
    ...
    */
    ...
    intakeReversedTrigger.onTrue(new IntakeSetCommand(intakeSubsystem, colorSensore, true, true,false,false));
    ...
    intakeToShooterTrigger.onTrue(new IntakeSetCommand(intakeSubsystem, colorSensore, true, false,true,false));
    ...
    intakeStopTrigger.onTrue(new IntakeSetCommand(intakeSubsystem, colorSensore, false, false, false,false));
